...
@app.route("/diet/<name>/<int:pagenum>") # here i'm excpecting url as a diet diet name (veg or non veg) and page (page num)
...
@app.route("/state/<name>/<diet>/<int:pagenum>") # here it expect state, name of the state, diet of dish and page num
...
@app.route("/region/<name>/<diet>/<int:pagenum>") # it excpect a region, name of region, diet and page number
...
@app.route("/recipe/<name>") # it except a recipe and dish name of the recipe
def recipe(name):
